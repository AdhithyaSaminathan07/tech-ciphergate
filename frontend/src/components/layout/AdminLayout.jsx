...
const AdminLayout = () => {
  ...
  const sidebarLinks = [
    ...
    },
    {
      ...
      isDropdown: true,
      children: [
        { to: '/admin/workers', label: 'Developers', icon: <FaUserTie /> },
    ...
    },
    {
      ...
      children: [
        ...
        { to: '/admin/compensation', label: 'Developer Comp.', icon: <FaHandHoldingUsd /> },
    ...
    },
    {
      ...
      children: [
        ...
        { to: '/admin/test/employee-scores', label: 'Developer Scores', icon: <FaStar /> },
