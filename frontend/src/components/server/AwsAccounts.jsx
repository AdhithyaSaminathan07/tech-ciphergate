                ...
                {accounts.map(acc => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {acc.errorMessage && (
                        acc.errorMessage.includes("not enrolled") || acc.errorMessage.includes("not enabled") ? (
                          <div className="mt-3 p-4 bg-blue-50 border border-blue-100 rounded-2xl text-xs text-blue-800 font-medium leading-relaxed flex flex-col gap-2 shadow-sm">
